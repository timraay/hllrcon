...
from scripts.extractlib.loader import load_object_from_file, local_to_abs_path
...
class LoadoutLocation(BaseModel):
    ...
    def read(self) -> "HLLTeamLoadouts":
        ...
        return load_object_from_file(fp, self.index, HLLTeamLoadouts)
    ...
    for role, loadouts_for_role in loadouts.properties.items():
        for loadout in loadouts_for_role:
            ...
            loadout_id = (
                ...
                f"_{str(loadout.display_name).replace(' ', '_').upper()}"
            )
            ...
            for item in loadout.loadout_items:
                item_name = str(
                    ...
                    .properties.weapon_meta_data.get(HLLLoadoutItem)
                    .display_name,
                )
