...
class TestCommands:
    ...
    async def test_commands_change_sector_layout(self) -> None:
        ...
        ).change_sector_layout(sector1, sector2, sector3, sector4, sector5)
    ...
    async def test_commands_move_map_from_sequence(self) -> None:
        ...
        ).move_map_from_sequence(old_index, new_index)
    ...
    async def test_commands_remove_ban(self) -> None:
        ...
        commands.remove_temp_ban.assert_called_once_with("pid")
