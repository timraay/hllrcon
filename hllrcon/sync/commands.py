...
def cast_response_to_model(
    ...
    def decorator(
        ...
        @wraps(func)
        def wrapper(*args: P.args, **kwargs: P.kwargs) -> ModelT | T:
...
class _SyncRconCommands(ABC):
    ...
    def set_notice_message(self, message: str) -> None:
        """Set the welcome message for the server.
        ...
        """
        return self.set_welcome_message(message)
    ...
    def reset_vote_kick_thresholds(self) -> None:
        ...
        self.execute("ResetVoteKickThreshold", 2)
    ...
    def set_num_vip_slots(self, num: int) -> None:
...
class HLLVSyncRconCommands(_SyncRconCommands):
    ...
    def get_sector_layouts(self) -> str:
        ...
        """
        return self.execute("GetSectorLayout", 2)

    def remove_sector_layout(self, map_id: str | AnyLayer) -> None:
        ...
        """
        self.execute("RemoveSectorLayout", 2, {"MapId": str(map_id)})
...
AnySyncRconCommands: TypeAlias = HLLSyncRconCommands | HLLVSyncRconCommands
