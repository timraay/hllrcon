...
class Loadout(IndexedBaseModel[LoadoutId]):
    ...
    def US_RIFLEMAN_POINT_MAN(cls) -> "Loadout":
        return cls(
            ...
            items=[
                LoadoutItem(name="M1 CARBINE", amount=12),
                LoadoutItem(name="MK2 GRENADE", amount=4),
                LoadoutItem(name="M18 SMOKE GRENADE", amount=2),
                LoadoutItem(name="HAMMER", amount=1),
                LoadoutItem(name="BANDAGE", amount=2),
                LoadoutItem(name="M3 KNIFE", amount=1),
    ...
    def US_ASSAULT_RAIDER(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="MK2 GRENADE", amount=1),
                LoadoutItem(name="M18 SMOKE GRENADE", amount=2),
    ...
    def US_AUTOMATIC_RIFLEMAN_STANDARD_ISSUE(cls) -> "Loadout":
        return cls(
            ...
            requires_level=1,
            items=[
                LoadoutItem(name="M1918A2 BAR", amount=10),
                LoadoutItem(name="MK2 GRENADE", amount=2),
                LoadoutItem(name="BANDAGE", amount=2),
                LoadoutItem(name="HAMMER", amount=1),
                LoadoutItem(name="M3 KNIFE", amount=1),
    ...
    def US_SUPPORT_FLAMER(cls) -> "Loadout":
        return cls(
            ...
            requires_level=8,
            items=[
                LoadoutItem(name="M2 FLAMETHROWER", amount=1),
                LoadoutItem(name="COLT M1911", amount=4),
                LoadoutItem(name="BANDAGE", amount=2),
                LoadoutItem(name="M18 SMOKE GRENADE", amount=2),
                LoadoutItem(name="SUPPLIES", amount=1),
    ...
    def US_ANTI_TANK_GUN_CREW(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="HAMMER", amount=1),
                LoadoutItem(name="BANDAGE", amount=2),
                LoadoutItem(name="57MM M1", amount=1),
                LoadoutItem(name="M3 KNIFE", amount=1),
            ],
        )
    ...
    def GER_RIFLEMAN_STURMTRUPPEN(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="WALTHER P38", amount=10),
    ...
    def GER_ASSAULT_RAIDER(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="M43 STIELHANDGRANATE", amount=1),
                LoadoutItem(name="NB39 NEBELHANDGRANATE", amount=2),
                LoadoutItem(name="SATCHEL", amount=1),
                LoadoutItem(name="HAMMER", amount=1),
                LoadoutItem(name="BANDAGE", amount=2),
    ...
    def GER_SUPPORT_FLAMMENWERFER(cls) -> "Loadout":
        return cls(
            ...
            requires_level=8,
            items=[
                LoadoutItem(name="FLAMMENWERFER 41", amount=1),
                LoadoutItem(name="WALTHER P38", amount=4),
                LoadoutItem(name="BANDAGE", amount=2),
                LoadoutItem(name="NB39 NEBELHANDGRANATE", amount=2),
                LoadoutItem(name="SUPPLIES", amount=1),
    ...
    def GER_ANTI_TANK_GUN_CREW(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="HAMMER", amount=1),
                LoadoutItem(name="BANDAGE", amount=2),
                LoadoutItem(name="PAK 40", amount=1),
                LoadoutItem(name="FELDSPATEN", amount=1),
            ],
        )
    ...
    def GER_ENGINEER_STANDARD_ISSUE(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="TELLERMINE 43", amount=1),
                LoadoutItem(name="FELDSPATEN", amount=1),
            ],
        )
    ...
    def GER_ARTILLERY_OBSERVER_NCO(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="NB39 NEBELHANDGRANATE", amount=2),
                LoadoutItem(name="WATCH", amount=1),
                LoadoutItem(name="S-MINE", amount=1),
                LoadoutItem(name="DIENSTGLAS 6×30", amount=1),
                LoadoutItem(name="FLARE GUN", amount=1),
                LoadoutItem(name="BANDAGE", amount=2),
                LoadoutItem(name="FELDSPATEN", amount=1),
    ...
    def GER_ARTILLERY_SUPPORT_STANDARD_ISSUE(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="SUPPLIES", amount=1),
                LoadoutItem(name="HAMMER", amount=1),
                LoadoutItem(name="FELDSPATEN", amount=2),
            ],
        )
    ...
    def SOV_ASSAULT_FLAMER(cls) -> "Loadout":
        return cls(
            ...
            items=[
                LoadoutItem(name="PPSH 41 W/DRUM", amount=5),
                LoadoutItem(name="MOLOTOV", amount=2),
                LoadoutItem(name="SATCHEL CHARGE", amount=1),
                LoadoutItem(name="HAMMER", amount=1),
                LoadoutItem(name="BANDAGE", amount=2),
                LoadoutItem(name="MPL-50 SPADE", amount=1),
            ],
    ...
    def SOV_MEDIC_STANDARD_ISSUE(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="REVIVE", amount=20),
                LoadoutItem(name="BANDAGE", amount=20),
                LoadoutItem(name="MPL-50 SPADE", amount=1),
            ],
        )
    ...
    def SOV_ANTI_TANK_GUN_CREW(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="HAMMER", amount=1),
                LoadoutItem(name="BANDAGE", amount=2),
                LoadoutItem(name="ZiS-2", amount=1),
                LoadoutItem(name="MPL-50 SPADE", amount=1),
            ],
        )
    ...
    def SOV_ENGINEER_STANDARD_ISSUE(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="TM-35 AT MINE", amount=1),
                LoadoutItem(name="MPL-50 SPADE", amount=1),
            ],
        )
    ...
    def SOV_ARTILLERY_OBSERVER_NCO(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="RDG-2 SMOKE", amount=2),
                LoadoutItem(name="WATCH", amount=1),
                LoadoutItem(name="POMZ AP MINE", amount=1),
                LoadoutItem(name="RKKA 8×40", amount=1),
                LoadoutItem(name="FLARE GUN", amount=1),
                LoadoutItem(name="BANDAGE", amount=2),
                LoadoutItem(name="MPL-50 SPADE", amount=1),
    ...
    def CW_RIFLEMAN_TROOPER(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="Mills Bomb", amount=2),
                LoadoutItem(name="Bandage", amount=2),
                LoadoutItem(name="Hammer", amount=2),
                LoadoutItem(name="Explosive Ammo Box", amount=1),
                LoadoutItem(name="Fairbairn–Sykes", amount=1),
            ],
        )
    ...
    def CW_ARTILLERY_ENGINEER_PIONEER(cls) -> "Loadout":
        return cls(
            ...
            items=[
                ...
                LoadoutItem(name="Hammer", amount=1),
                LoadoutItem(name="Torch", amount=1),
                LoadoutItem(name="Fairbairn–Sykes", amount=2),
            ],
        )
    ...
    def B8A_ARTILLERY_ENGINEER_PIONEER(cls) -> "Loadout":
        return cls(
            ...
            requires_level=3,
            items=[
                LoadoutItem(name="Bren Gun", amount=6),
                LoadoutItem(name="Bandage", amount=2),
                LoadoutItem(name="A.P. Shrapnel Mine Mk II", amount=2),
                LoadoutItem(name="No.77", amount=2),
                LoadoutItem(name="Hammer", amount=1),
