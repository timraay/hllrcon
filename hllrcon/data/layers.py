...
# Simple code block to prevent isort from merging autogenerated and manual imports
if True:
    ### INJECT "hllv sector imports" START

    from hllrcon.data.sectors import (
        SECTORS_CAM_RANH_PORT_CONQUEST,
        SECTORS_CAM_RANH_PORT_WARFARE,
        SECTORS_DAK_TO_AIRFIELD_CONQUEST,
        SECTORS_DAK_TO_AIRFIELD_WARFARE,
        SECTORS_HUE_OUTSKIRTS_CONQUEST,
        SECTORS_HUE_OUTSKIRTS_WARFARE,
        SECTORS_QUANG_NGAI_CONQUEST,
        SECTORS_QUANG_NGAI_WARFARE,
        SECTORS_THANH_HOA_BRIDGE_CONQUEST,
        SECTORS_THANH_HOA_BRIDGE_WARFARE,
        SECTORS_VAN_TUONG_CONQUEST,
        SECTORS_VAN_TUONG_WARFARE,
    )

    ### INJECT "hllv sector imports" END
